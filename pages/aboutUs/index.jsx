               ...
               <Grid item xs={12} md={7} order={{ xs: 2, md: 1 }}>
                  <div className="flex h-full flex-col justify-center">
                     ...
                     <p className="my-8 text-sm leading-[30px] customMd:text-lg customMd:leading-[40px]">
                        ...
                        نظیر شما عزیزان در مدت زمان کوتاه ، توانست رضایت و اعتماد شما عزیزان را جلب کند. با توجه به حجم
                        بالای سفارشات و استقبال بی نظیر شما، در جهت بهبود بخشیدن در حوزه فروش آنلاین، سایت فروشگاه یاسی
